            ...
            <div className="audio-call-actions">
              {callState === 'ringing' ? (
                ...
                <>
                  ...
                  {toggleSpeaker ? (
                    <CallActionButton kind={`speaker ${isSpeakerOn ? 'active' : ''}`} label={isSpeakerOn ? t('call.speakerOn', 'Բարձրախոս (Միացված)') : t('call.speakerOff', 'Առանց բարձրախոսի')} onClick={toggleSpeaker}>
...
function EndCallIcon() {
  return (
    <svg className="call-end-glyph" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M12 9c-1.6 0-3.15.25-4.6.72v3.1c0 .39-.23.74-.58.9-.98.49-1.88 1.12-2.66 1.85a.98.98 0 0 1-.69.28c-.28 0-.53-.11-.71-.29L.29 13.09a1 1 0 0 1 0-1.41C3.34 8.78 7.46 7 12 7s8.66 1.78 11.71 4.68a1 1 0 0 1 0 1.41l-2.48 2.48c-.18.18-.43.29-.7.29-.26 0-.51-.1-.69-.28a12.5 12.5 0 0 0-2.67-1.85 1 1 0 0 1-.57-.9v-3.1A15.5 15.5 0 0 0 12 9Z" />
    </svg>
  );
}
...
function SpeakerOnIcon() {
  return <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M11 5L6 9H2v6h4l5 4V5z" /><path d="M15.54 8.46a5 5 0 0 1 0 7.07" /><path d="M19.07 4.93a10 10 0 0 1 0 14.14" /></svg>;
}

function SpeakerOffIcon() {
  return <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M11 5L6 9H2v6h4l5 4V5z" /><line x1="23" y1="9" x2="17" y2="15" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" /><line x1="17" y1="9" x2="23" y2="15" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" /></svg>;
}
