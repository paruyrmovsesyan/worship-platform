    ...
    <footer className="footer">
      ...
      <div className="rich-footer">
        ...
        <div className="footer-links">
          {[
            { title: t('landing.footer.product'), links: [[t('landing.footer.songs'), '/songs'], [t('nav.transposer'), '/transpose'], [t('nav.friends', 'Ընկերներ'), '/friends'], [t('landing.footer.setlists'), '/setlists']] },
