...
const translations = {
  am: {
    ...
    landing: {
      ...
      installApp: 'Պահպանել որպես ծրագիր',
    ...
    favorites: {
      ...
      sortCustom: 'Իմ դասավորությամբ',
      reorder: 'Վերադասավորել',
      saveOrder: 'Պահպանել',
      reorderDone: 'Հերթականությունը պահպանվեց',
    ...
    profile: {
      ...
      userProfile: 'Օգտատիրոջ պրոֆիլ',
      startChat: 'Զրուցել',
      startCall: 'ԱուդիոԶանգ',
      isFriend: 'Ընկերներ եք',
      addFriend: 'Ավելացնել ընկեր',
      ...
      userSetlists: 'Երգացանկեր',
      noUserSetlists: 'Ակտիվ երգացանկեր չկան',
      songsCount: 'երգ',
      onlineNow: 'Առցանց',
      offline: 'Անցանց',
      lastSeen: 'Վերջին անգամ՝',
      userNotFound: 'Օգտատերը չի գտնվել',
      backToChat: 'Վերադառնալ չաթ',
      currentPlan: 'Ընթացիկ փաթեթ',
      loading: 'Բեռնվում է...',
      upgradePlan: 'Փոխել փաթեթը',
      savedSongs: 'Պահպանված երգեր',
      friendsChat: 'Ընկերներ / Չաթ',
      myTeams: 'Իմ թիմերը',
      ...
      selectLanguageSubtitle: 'Ընտրեք հավելվածի հիմնական լեզուն',
      chooseRoleInTeam: '🎭 Ընտրել դերը թիմում',
      changeAvatarTitle: 'Փոխել ավատարը / դերը',
      roleModalTitle: '🎭 Երկրպագության Թիմի Դեր & Ավատար',
      chooseAvatarColor: '🎨 Ընտրել Ավատարի Գույնը',
      chooseYourRole: '📖 Ընտրել Ձեր Դերը Թիմում',
      saveBtn: 'Պահպանել',
      saving: 'Պահպանվում է...',
      workspace: 'Աշխատանքային Տարածք',
      personalInfo: 'Անձնական Տվյալներ',
      setlists: 'Երգացանկեր',
      myRequests: 'Իմ Հարցումները',
      userType: 'Օգտատիրոջ տեսակ',
      fullSettings: 'Ամբողջական Կարգավորումներ',
      fullSettingsDesc: 'Անվտանգություն, Սեսիաներ, Ծրագրի ռեժիմներ',
      openBtn: 'Բացել',
      savedSongsCardDesc: '{{count}} երգ պահպանված է Ձեր անձնական հավաքածուում։',
      setlistsCardDesc: '{{count}} երգացանկ պատրաստ է փորձերի և ծառայությունների համար։',
      friendsCardDesc: 'Կապ հաստատեք թիմի անդամների հետ և կիսվեք երգացանկերով։',
      requestsCardDesc: 'Նոր երգերի ավելացման կամ առաջարկած խմբագրումների կարգավիճակը։',
    ...
    support: {
      supportTitle: 'Աջակցություն և կապ',
      desc: 'Ունե՞ք հարցեր, առաջարկություններ կամ նկատել եք խնդիր։ Կապվեք մեզ հետ։',
      emailTitle: 'Էլ․ փոստ (Email)',
      orSendDirect: 'կամ ուղարկեք հաղորդագրություն ծրագրից',
      topicLabel: 'Թեմա',
      topicQuestion: '❓ Հարց կամ օգնություն',
      topicFeature: '💡 Առաջարկություն',
      topicBug: '🛠 Սխալի մասին հայտնում',
      topicOther: '💬 Այլ',
      contactLabel: 'Ձեր կոնտակտը (Telegram / Email / Հեռախոս)` պատասխանի համար',
      messageLabel: 'Հաղորդագրություն',
      messagePlaceholder: 'Նկարագրեք Ձեր հարցը կամ առաջարկությունը...',
      sendBtn: 'Ուղարկել',
      messageRequired: 'Խնդրում ենք գրել հաղորդագրության տեքստը',
      sentSuccess: 'Ձեր հաղորդագրությունը հաջողությամբ ուղարկվեց։'
    },
    chats: {
      chats: 'Չաթեր'
    },
  ...
  en: {
    ...
    profile: {
      ...
      userSetlists: 'Setlists',
      noUserSetlists: 'No active setlists',
      songsCount: 'songs',
      onlineNow: 'Online',
      offline: 'Offline',
      lastSeen: 'Last seen',
      ...
      selectLanguageSubtitle: 'Select primary application language',
      chooseRoleInTeam: '🎭 Choose role in team',
      changeAvatarTitle: 'Change avatar / role',
      roleModalTitle: '🎭 Worship Team Role & Avatar',
      chooseAvatarColor: '🎨 Choose Avatar Color',
      chooseYourRole: '📖 Choose Your Role in Team',
      saveBtn: 'Save',
      saving: 'Saving...',
      workspace: 'Workspace',
      ...
      fullSettingsDesc: 'Security, Sessions, App modes',
      openBtn: 'Open',
      savedSongsCardDesc: '{{count}} songs saved in your personal collection.',
      setlistsCardDesc: '{{count}} setlists ready for rehearsals and services.',
      friendsCardDesc: 'Connect with team members and share setlists.',
      requestsCardDesc: 'Status of newly added songs or suggested edits.',
    ...
    support: {
      supportTitle: 'Support & Contact',
      desc: 'Have questions, suggestions, or noticed an issue? Contact us.',
      emailTitle: 'Email',
      orSendDirect: 'or send a message directly from the app',
      topicLabel: 'Topic',
      topicQuestion: '❓ Question or Help',
      topicFeature: '💡 Suggestion',
      topicBug: '🛠 Bug Report',
      topicOther: '💬 Other',
      contactLabel: 'Your contact (Telegram / Email / Phone) for reply',
      messageLabel: 'Message',
      messagePlaceholder: 'Describe your question or suggestion...',
      sendBtn: 'Send',
      messageRequired: 'Please enter a message text',
  ...
  ru: {
    ...
    landing: {
      ...
      installApp: 'Сохранить как приложение',
    ...
    favorites: {
      ...
      sortCustom: 'Порядок пользователя',
      reorder: 'Изменить порядок',
      saveOrder: 'Сохранить',
      reorderDone: 'Порядок сохранен',
    ...
    profile: {
      ...
      userSetlists: 'Сет-листы',
      noUserSetlists: 'Нет активных сет-листов',
      songsCount: 'песен',
      onlineNow: 'В сети',
      offline: 'Не в сети',
      ...
      selectLanguageSubtitle: 'Выберите основной язык приложения',
      chooseRoleInTeam: '🎭 Выбрать роль в команде',
      changeAvatarTitle: 'Изменить аватар / роль',
      roleModalTitle: '🎭 Роль в команде прославления и аватар',
      chooseAvatarColor: '🎨 Выберите цвет аватара',
      chooseYourRole: '📖 Выберите вашу роль в команде',
      saveBtn: 'Сохранить',
      saving: 'Сохранение...',
      ...
      fullSettingsDesc: 'Безопасность, Сессии, Режимы приложения',
      openBtn: 'Открыть',
      savedSongsCardDesc: '{{count}} песен сохранено в вашей личной коллекции.',
      setlistsCardDesc: '{{count}} сет-листов готово для репетиций и служений.',
      friendsCardDesc: 'Связывайтесь с участниками команды и делитесь сет-листами.',
      requestsCardDesc: 'Статус добавления новых песен или предложенных правок.',
    ...
    support: {
      supportTitle: 'Поддержка и связь',
      desc: 'Есть вопросы, предложения или заметили проблему? Свяжитесь с нами.',
      emailTitle: 'Эл. почта (Email)',
      orSendDirect: 'или отправьте сообщение прямо из приложения',
      topicLabel: 'Тема',
      topicQuestion: '❓ Вопрос или помощь',
      topicFeature: '💡 Предложение',
      topicBug: '🛠 Сообщение об ошибке',
      topicOther: '💬 Другое',
      contactLabel: 'Ваш контакт (Telegram / Email / Телефон) для ответа',
