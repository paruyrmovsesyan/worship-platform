        ...
        <div className="contact-left">
          ...
          <div className="info-grid">
            ...
            <div className="info-card">
              ...
              <p>{window.SITE_CONFIG?.contactEmail || 'info@worship.pmstudio.am'}</p>
            </div>
            <div className="info-card">
              ...
              <p>{window.SITE_CONFIG?.contactPhone || '+374 00 000000'}</p>
            </div>
            <div className="info-card">
              ...
              <p>{window.SITE_CONFIG?.contactAddress || t('contact.officeValue')}</p>
            </div>
          </div>
        </div>
