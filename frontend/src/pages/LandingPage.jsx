        ...
        <div className="col-sidebar">
          ...
          <div>
            ...
            <nav className="sidebar-filter-nav">
              <a href="#" className="active">Songs</a>
              <a href="#">Artists</a>
        ...
        <div className="footer-content">
          ...
          <div className="footer-links">
            {[
              ...
              { title: 'Company', links: [['About', '/community'], ['Blog', '/news'], ['Careers', '#'], ['Community', '/community']] },
              { title: 'Resources', links: [['Documentation', '/resources'], ['Tutorials', '/resources'], ['Pricing', '/pricing'], ['Support', '/community']] },
