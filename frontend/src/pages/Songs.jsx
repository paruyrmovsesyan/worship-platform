    ...
    <div className="songs-page">
      ...
      <div className="song-list-wrap">
        ...
        <div className="song-row header-row">
          ...
          <div className="col-bpm desk-only">{t('songs.tableBpm')}</div>
          <div className="col-artist desk-only">{t('songs.tableAuthor')}</div>
          <div className="col-date desk-only">{t('songs.tableAdded')}</div>
          ...
          <div key={song.id} className="song-row data-row"
            ...
            <div className="col-name">
              ...
              <div className="s-name-block">
                ...
                <span className="s-artist-sm desk-hide">{song.artist}</span>
              </div>
            </div>
            ...
            <div className="col-bpm desk-only dim">{song.bpm || '—'}</div>
            <div className="col-artist desk-only dim">{song.artist || ''}</div>
            <div className="col-date desk-only dim">{getTimeAgo(song.created_at)}</div>
