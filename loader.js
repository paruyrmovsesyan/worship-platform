...
(function(){
  ...
  function ensureStandaloneAppChrome() {
    ...
    var apply = function() {
      ...
      if (isIOS) {
        document.documentElement.classList.add("wp-ios-app");
        document.body.classList.add("wp-ios-app");
      }
      ...
      style.textContent =
        ...
        "@media (max-width:720px){body.wp-standalone-app{padding-top:max(8px,env(safe-area-inset-top));padding-right:max(8px,env(safe-area-inset-right));padding-bottom:max(16px,env(safe-area-inset-bottom));padding-left:max(8px,env(safe-area-inset-left))}body.wp-standalone-app.wp-ios-app{padding-top:max(44px,env(safe-area-inset-top))}body.wp-standalone-app .header{border-radius:18px}}";
      document.head.appendChild(style);
    };
    ...
    var apply = function() {
      ...
      if (!document.getElementById("wpStandaloneAppUiStyles")) {
        ...
        style.textContent =
          ...
          "body.wp-main-app .wp-app-dock-link span.wp-app-dock-label-full{font-size:14px;font-weight:600;white-space:nowrap;opacity:0;max-width:0;transition:all .35s cubic-bezier(.25,1,.5,1);display:block!important}" +
          "body.wp-main-app .wp-app-dock-link.active span.wp-app-dock-label-full,body.wp-main-app .wp-app-dock-link.is-preview span.wp-app-dock-label-full{opacity:1;max-width:100px;color:#ffffff;transform:none}" +
          "@media (max-width:720px){body.wp-main-app .container{padding-bottom:122px!important}}";
          document.head.appendChild(style);
      }
      ...
      if (!dock) {
        var links = [
          { href: "/?source=pwa", key: "home", label: i18nText("app.dock.home", "Գլխավոր"), shortLabel: i18nText("app.dock.home", "Գլխավոր"), icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>' },
          { href: "/songs?source=pwa", key: "songs", label: i18nText("app.dock.songs", "Երգեր"), shortLabel: i18nText("app.dock.songs", "Երգեր"), icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>' },
          { href: "/setlists?source=pwa", key: "setlists", label: i18nText("app.dock.setlists", "Երգացանկ"), shortLabel: i18nText("app.dock.setlists", "Երգացանկ"), icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18" x2="21" y2="18"></line><line x1="3" y1="6" x2="3.01" y2="6"></line><line x1="3" y1="12" x2="3.01" y2="12"></line><line x1="3" y1="18" x2="3.01" y2="18"></line></svg>' },
          { href: "/login?next=/?source=pwa", key: "account", label: i18nText("app.dock.login", "Մուտք"), shortLabel: i18nText("app.dock.login", "Մուտք"), icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"></path><polyline points="10 17 15 12 10 7"></polyline><line x1="15" y1="12" x2="3" y2="12"></line></svg>' }
        ];
          ...
          if (!isLoggedIn && prevState !== "guest") {
            ...
            if (path === "/account.html") {
              ...
              var target = (window.WP && typeof window.WP.withAppSource === "function")
                ? window.WP.withAppSource("/login?next=" + encodeURIComponent(next))
