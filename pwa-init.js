    ...
    var apply = function() {
      ...
      style.textContent = isAdmin
        ...
        : "html.wp-standalone-app{background:#05050A;color-scheme:dark}" +
          ...
          "@media (max-width:720px){body.wp-standalone-app{padding-top:env(safe-area-inset-top, 0px);padding-right:env(safe-area-inset-right, 0px);padding-bottom:max(16px,env(safe-area-inset-bottom));padding-left:env(safe-area-inset-left, 0px)}body.wp-standalone-app.wp-ios-app{padding-top:max(44px,env(safe-area-inset-top))}}";
